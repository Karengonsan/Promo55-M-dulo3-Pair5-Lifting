import 'react' //esto siempre debe estar
import logoPacho from '../images/gazpacho.png'
import '../styles/app.css' //esto siempre debe estar 

const App = () => {
return (
    <div>
        <h1>GAZPACHO</h1>
<img src = {logoPacho} alt="Logo gazpacho" />
        ...
        <section>
            ...
            <div>
        <section className="andalusian-gazpacho">
